...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            categorical_cols = ['workclass', 'education', 'marital_status', 'occupation', 'relationship', 'race', 'sex', 'nativecountry']
            ...
            occupation_categories = [' Adm-clerical', ' Exec-managerial', ' Handlers-cleaners',
                ...
                ' Tech-support', 'NanN', ' Protective-serv', ' Armed-Forces',
                ' Priv-house-serv']
            relationship_categories = [' Not-in-family', ' Husband', ' Wife', ' Own-child', ' Unmarried',
                ' Other-relative']
            race_categories = [' White', ' Black', ' Asian-Pac-Islander', ' Amer-Indian-Eskimo',
                ' Other']
            sex_categories = [' Male', ' Female']
            native_country_categories = [' United-States', ' Cuba', ' Jamaica', ' India', 'NanN', ' Mexico',
